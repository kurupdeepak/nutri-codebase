...
from nutrition.core.transformer import VITConfig
from nutrition.core.transformer.swin import SwinConfig, PatchExtract, PatchEmbedding, SwinTransformer, PatchMerging
...
class ModelCreator:
    ...
    def create_swin(swin_config: SwinConfig,
        ...
        x = PatchEmbedding(swin_config.num_patch_x * swin_config.num_patch_y, swin_config.dim)(x)
        x = SwinTransformer(swin_config)(x)
        swin_config_shift_1 = copy.deepcopy(swin_config)
        swin_config_shift_1.shift_size = 1
        x = SwinTransformer(swin_config_shift_1)(x)
        x = PatchMerging((swin_config.num_patch_x, swin_config.num_patch_y), embed_dim=swin_config.dim)(x)
